      ...
      <div className="links">
        <div className="contact-info">
          <a href="mailto:iqbalumairi@gmail.com" target="_blank">
            <EmailIcon fontSize="large" sx={{ color: "#173d4f" }} />
          </a>
          ...
          <a
            ...
            target="_blank"
          >
            <LinkedInIcon fontSize="large" sx={{ color: "#173d4f" }} />
          </a>
          <a href="https://github.com/Umair-Iqbal-debug" target="_blank">
            <GitHubIcon fontSize="large" sx={{ color: "#173d4f" }} />
          </a>
          <InstagramIcon fontSize="large" sx={{ color: "#173d4f" }} />
